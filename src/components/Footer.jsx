...
export default function Footer(){
    return(<footer class="bg-neutral-900 text-center text-white">
    <div className="footer-all" class="container px-6 pt-6">
        ...
        <form action="">
          <div
            ...
            <div class="relative md:mb-6" data-te-input-wrapper-init>
              <input
                type="text"
                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0 focus:outline-blue-800"
    ...
    classname="bottom-foot"
    >
    © 2023 Copyright:
    <a class="text-white" href="https://tailwind-elements.com/"> FitACAD </a>
  </div>
</footer>)
}